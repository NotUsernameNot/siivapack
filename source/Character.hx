...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-scat':
				...
				if(Performance.getPref('low-gf')) {
					...
					tex = Paths.getSparrowAtlas('characters/GF_scat');
					frames = tex;
					quickAnimAdd('cheer', 'GF Cheer');
					quickAnimAdd('singLEFT', 'GF left note');
					quickAnimAdd('singRIGHT', 'GF Right Note');
			...
			case 'gf-ayo':
				tex = Paths.getSparrowAtlas('characters/GF_yellow_assets');
				frames = tex;
				quickAnimAdd('cheer', 'GF Cheer');
				quickAnimAdd('singLEFT', 'GF left note');
				quickAnimAdd('singRIGHT', 'GF Right Note');
		...
		/*	case 'gf-tankmen':
			...
			case 'dad':
				...
				/*else if(PlayState.SONG.song.toLowerCase() == 'dadbattle-jp-version') {
					isNormalDad = false;
					icon = 'ragyo';
					tex = Paths.getSparrowAtlas('characters/ragyo');
					frames = tex;
					...
					loadOffsetFile('mom-car'); //I was wondering why dadbattle jp wasnt working so i switched that car and realized the offset file is missing lol
				...
				/*else if(PlayState.SONG.song.toLowerCase() == 'test') {
					...
					icon = 'doubledad';
					if(Performance.getPref('low-dad')) {
						tex = Paths.getSparrowAtlas('characters/DADDY_DEAREST_SURF');
						frames = tex;
						quickAnimAdd('idle', 'Dad idle dance');
						quickAnimAdd('singUP', 'Dad Sing Note UP');
						quickAnimAdd('singRIGHT', 'Dad Sing Note RIGHT');
				...
				else if(PlayState.SONG.song.toLowerCase() == 'fresh-poop-version') {
					icon = 'harkinian';
					if(Performance.getPref('low-dad')) {
						tex = Paths.getSparrowAtlas('characters/KING_HARKINIAN');
						frames = tex;
						quickAnimAdd('idle', 'Dad idle dance');
						quickAnimAdd('singUP', 'Dad Sing Note UP');
						quickAnimAdd('singRIGHT', 'Dad Sing Note RIGHT');
			...
			case 'dad-imposter':
				if(Performance.getPref('low-dad')) {
					...
					tex = Paths.getSparrowAtlas('characters/DADDY_DEAREST_IMPOSTER');
					frames = tex;
					quickAnimAdd('idle', 'Dad idle dance');
					quickAnimAdd('singUP', 'Dad Sing Note UP');
					quickAnimAdd('singRIGHT', 'Dad Sing Note RIGHT');
			...
			case 'bigchungus':
				tex = Paths.getSparrowAtlas('characters/chung');
				frames = tex;
				quickAnimAdd('idle', 'Dad idle dance');
				quickAnimAdd('singUP', 'Dad Sing Note UP');
				quickAnimAdd('singRIGHT', 'Dad Sing Note RIGHT');
		...
		/*	case 'monster-christmas':
			...
			case 'pico':
				isNormalDad = false;
				if(PlayState.SONG.song.toLowerCase() == 'fresh-week-7-update') {
					icon = 'plok';
					tex = Paths.getSparrowAtlas('characters/Plok');
					frames = tex;
				...
				else if(PlayState.SONG.song.toLowerCase() == 'dadbattle-in-game-mix') {
					tex = Paths.getSparrowAtlas('characters/crank_dat_who');
					frames = tex;
					quickAnimAdd('idle', "Pico Idle Dance");
					quickAnimAdd('singUP', 'pico Up note0');
					quickAnimAdd('singDOWN', 'Pico Down Note0');
				...
				else if(PlayState.SONG.song.toLowerCase() == 'dadbattle-in-game-version') {
					icon = 'mario';
					tex = Paths.getSparrowAtlas('characters/crank_dat_super_mario');
					frames = tex;
					quickAnimAdd('idle', "Pico Idle Dance");
					quickAnimAdd('singUP', 'pico Up note0');
					quickAnimAdd('singDOWN', 'Pico Down Note0');
					...
					isNormalDad = true;
					tex = Paths.getSparrowAtlas('characters/Pico_FNF_assets');
					frames = tex;
					quickAnimAdd('idle', "Pico Idle Dance");
					quickAnimAdd('singUP', 'pico Up note0');
					quickAnimAdd('singDOWN', 'Pico Down Note0');
			...
			case 'bf':
				isNormalBF = false;
				if(PlayState.SONG.song.toLowerCase() == 'fresh-ost-version') {
					if(Performance.getPref('low-bf')) {
						tex = Paths.getSparrowAtlas('characters/BOYFRIEND_SURF');
						frames = tex;
					...
					iconBF = 'link';
					if(Performance.getPref('low-bf')) {
						tex = Paths.getSparrowAtlas('characters/LINK');
						frames = tex;
						quickAnimAdd('idle', 'BF idle dance');
						quickAnimAdd('singUP', 'BF NOTE UP0');
						quickAnimAdd('singLEFT', 'BF NOTE LEFT0');
					...
					iconBF = 'ryuko';
					if(Performance.getPref('low-bf')) {
						tex = Paths.getSparrowAtlas('characters/RYUKO');
						frames = tex;
						quickAnimAdd('idle', 'BF idle dance');
						quickAnimAdd('singUP', 'BF NOTE UP0');
						quickAnimAdd('singLEFT', 'BF NOTE LEFT0');
					...
					isNormalBF = true;
					if(Performance.getPref('low-bf')) {
						tex = Paths.getSparrowAtlas('characters/BOYFRIEND_low');
						frames = tex;
						quickAnimAdd('idle', 'BF idle dance');
						quickAnimAdd('singUP', 'BF NOTE UP0');
						quickAnimAdd('singLEFT', 'BF NOTE LEFT0');
			...
			case 'bf-crew':
				if(Performance.getPref('low-bf')) {
					tex = Paths.getSparrowAtlas('characters/BOYFRIEND_CREWMATE');
					frames = tex;
					quickAnimAdd('idle', 'BF idle dance');
					quickAnimAdd('singUP', 'BF NOTE UP0');
					quickAnimAdd('singLEFT', 'BF NOTE LEFT0');
				...
				case 'bf-deez':
					if(Performance.getPref('low-bf')) {
						tex = Paths.getSparrowAtlas('characters/BOYFRIEND_DEEZ');
						frames = tex;
						quickAnimAdd('idle', 'BF idle dance');
						quickAnimAdd('singUP', 'BF NOTE UP0');
						quickAnimAdd('singLEFT', 'BF NOTE LEFT0');
				...
				case 'bf-scat':
						if(Performance.getPref('low-bf')) {
							tex = Paths.getSparrowAtlas('characters/BOYFRIEND_SCAT');
							frames = tex;
							quickAnimAdd('idle', 'BF idle dance');
							quickAnimAdd('singUP', 'BF NOTE UP0');
							quickAnimAdd('singLEFT', 'BF NOTE LEFT0');
